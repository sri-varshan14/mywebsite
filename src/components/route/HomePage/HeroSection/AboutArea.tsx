                ...
                <div className='flex flex-col items-end sm:items-center md:items-center lg:items-center'>
                    <div className='flex sm:pt-2 md:pt-3 lg:pt-5 gap-2 items-center'>
                        ...
                        {windowSize.width <= 1024 &&
                            <div className=''>
                                <p className='sm:visible md:visible lg:visible xl:hidden 2xl:hidden h3 font-semibold font-robotocon text-right sm:text-center md:text-center'>He/Him</p>
                                <span className='sm:visible md:visible lg:visible flex font-bold d2 font-robotocon items-end leading-normal sm:leading-tight'>Srivarshan&nbsp;<p className='font-medium font-robotocon d2 sm:leading-tight'>Geetha</p></span>
                    ...
                    <div className='py-5 sm:py-1 flex flex-col items-end sm:items-center md:items-center lg:items-center'>
                        {windowSize.width > 1024 &&
                            <>
                                <p className='sm:hidden md:hidden lg:hidden h3 font-semibold font-robotocon text-right sm:text-center md:text-center'>He/Him</p>
                                <span className='sm:hidden md:hidden lg:hidden flex font-bold d2 font-robotocon items-end leading-normal sm:leading-tight'>Srivarshan&nbsp;<p className='font-medium font-robotocon d2 sm:leading-tight'>Geetha</p></span>
                            </>
                        }
