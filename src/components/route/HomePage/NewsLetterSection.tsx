const NewsLetterSection = () => {
    return (
        <section className="w-screen bg-base-content px-[8vw] md:px-[6vw]">
            <div className="flex py-20 items-center justify-evenly flex-wrap">
                ...
                <div className="">
                    <form className="flex items-center gap-5 py-5">
                        <input className="bg-base-content border-b-2 border-b-base-100 text-base-100 outline-none body py-2 w-[30ch]" type="email" placeholder="Enter your email here" />
